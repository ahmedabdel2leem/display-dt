...
export default class Data extends Component {
    ...
    render(){
        ...
        <div className="row g-4">
         { this.recipes.map((val)=> <div key={val.recipe_id} className="col-md-4">
            <img src={val.image_url} className='w-100' height='300px' alt="" />
            <h3 className="text-center">{val.title}</h3>
            <a href={val.source_url} target="_blank" className="btn btn-primary w-100">Source</a>
          </div>
          )
        }
